...
@media (max-width: 900px) {
  ...
  /* Stage plus haut sur tablette pour mieux voir l'image */
  .phs-stage { aspect-ratio: auto; min-height: 380px; }
  .gm-stage  { aspect-ratio: auto; min-height: 340px; }
}
